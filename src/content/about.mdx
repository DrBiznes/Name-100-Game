...
In early 2024, a simple challenge emerged that would expose an unsurprising gap in humanities collective knowledge: Name 100 women. [NorthernLion's attempt](https://youtu.be/SqLEGFqgRfc?si=rpo2DjbnEuJoXr-7) at this challenge inspired me to create this game, with the goal of proving that any human can accomplish this task!<Note number={1}>This challenge originated from Twitch streamer QTCinderella in early 2024, after Obama's wife asked me to name 100 women.</Note>
